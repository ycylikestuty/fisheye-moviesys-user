	...
	<div class="app">
		<el-carousel height="500px" indicator-position="outside">
			<el-carousel-item v-for="(item, index) in posterList" :key="index">
				<img alt="" :src="item.url" style="width: 100%;height: 500px">
			</el-carousel-item>
		</el-carousel>
		<!-- <div class="as">
						...
						<ul class="ranking-wrapper ranking-mostExpect">
							...
							<li class="ranking-item ranking-index-2">
								<router-link :to="'/film/info?fid=' + top2.id" target="_blank">
									...
									<span class="img-link">
										<img style="height: 180px" class="ranking-img default-img" :alt="top2.name"
											:src="top2.cover"></span>
									<div class="name-link ranking-movie-name">{{ top2.name }}</div>
									<span class="ranking-num-info"><span class="stonefont">热度值:
										</span>{{ top2.hot }}</span>
								</router-link>
							</li>
							<li class="ranking-item ranking-index-3">
								<router-link :to="'/film/info?fid=' + top3.id" target="_blank">
									...
									<span class="img-link">
										<img style="height: 180px" class="ranking-img default-img" :alt="top3.name"
											:src="top3.cover"></span>
		...
		<div class="main">
			<div class="movie-grid">
				<div class="panel">
					<div class="panel-header">
						<span class="panel-title">
							<span class="textcolor_orange">高分电影 ( {{ filmList.length }} )</span>
						</span>
					</div>
					<div class="panel-content">
						<dl class="movie-list">
										...
										<div class="movie-poster">
											...
											<div class="movie-overlay movie-overlay-bg">
												<div class="movie-info">
													<div class="movie-title">{{ item.score }}分</div>
												</div>
											</div>
										</div>
		...
		<div class="main">
			<div class="movie-grid">
				<div class="panel">
					<div class="panel-header">
						<span class="panel-title">
							<span class="textcolor_orange">猜你喜欢 ( {{ loveFilmList.length }} )</span>
						</span>
					</div>
					<div class="panel-content">
						<dl class="movie-list">
							<dd v-for="item in loveFilmList">
								<router-link :to="'/film/info?fid=' + item.id">
									<div class="movie-item">
										<div class="movie-poster">
											<img class="movie-poster-img" :src="item.img">
...
<script>
	...
	export default {
		...
		data() {
			return {
				...
				// filmList: [
					...
					// {
					// 	id:3,
					// 	cover:require("@/assets/img/post1.jpg"),
					// 	name:"她她她",
					// 	score:"7.2"
					// },
					// {
				...
				posterList: [{
						...
						url: require("@/assets/img/post1.jpg")
					},
					{
						url: require("@/assets/img/post2.jpg")
					},
					{
						url: require("@/assets/img/post3.jpg")
					}
				]
			}
		},
		methods: {
			getHighScoreMovies() {
				this.$axios.get("/movie/getHighScoreMovies").then(res => {
			...
			getUserLikeMovies(){
				...
				this.$axios.post("/movie/getUserLikeMovies?userId="+info.id).then(res => {
					this.loveFilmList = res.data.result
				})
			}
		},
		...
		mounted() {
			...
			// })
			this.getHighScoreMovies();
			this.getUserLikeMovies();
